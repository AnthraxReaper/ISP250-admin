        ...
        <div class="main-content">
            ...
            <div class="content">
                ...
                <div class="form-container">
                    <form action="employeeupdprocess.php" method="POST">
						
						<label for="employee_fname">Employee First Name</label>
						<input type="text" name="fempfname" value="<?php echo htmlspecialchars($row['Emp_FirstName'], ENT_QUOTES, 'UTF-8'); ?>">

                        <label for="employee_lname">Employee Last Name</label>
						<input type="text" name="femplname" value="<?php echo htmlspecialchars($row['Emp_LastName'], ENT_QUOTES, 'UTF-8'); ?>">

						<label for="employee_ic">Employee IC</label>
                        <input type="text" name="fempic" value='<?php echo $row['Emp_NRIC']; ?>'>

                        <label for="employee_phone">Employee Phone</label>
                        <input type="text" name="fempphone" value='<?php echo $row['Emp_Phone']; ?>'>

                        <label for="employee_address">Employee Address</label>
						<input type="text" name="fempaddr" value="<?php echo htmlspecialchars($row['Emp_Address'], ENT_QUOTES, 'UTF-8'); ?>">
						
						<label for="employee_emergencyno">Employee Emergency Number</label>
                        <input type="text" name="fempemergencyno" value='<?php echo $row['Emp_EmergencyNo']; ?>'>

						<label for="employee_email">Employee Email</label>
                        <input type="text" name="fempemail" value='<?php echo $row['Emp_Email']; ?>'>
						
						<label for="employee_password">Employee Password</label>
                        <input type="text" name="femppass" value='<?php echo $row['Emp_Password']; ?>'>
